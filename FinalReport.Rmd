...
kable(df_roles, caption = 
        "Assumed Team Role Participant IDs -- eSports")
```
...
![Draft Pick Mode, Selection Screen](img/draft-pick.png)
...
We can find the match IDs the same way we found the API.  Figures 4 and 5 show the match ID strings we need to obtain match data for a particular match.
